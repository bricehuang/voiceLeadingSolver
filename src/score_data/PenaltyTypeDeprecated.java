 ...
 */
public enum PenaltyTypeDeprecated {
    ...
    private static final Map<PenaltyTypeDeprecated, String> STRING_REPS;
    static{
        Map<PenaltyTypeDeprecated, String> tmpStringReps = new HashMap<>();
    ...
    private static final Map<PenaltyTypeDeprecated, Integer> PENALTIES;
    static{
        Map<PenaltyTypeDeprecated, Integer> tmpPenalties = new HashMap<>();
